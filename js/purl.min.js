!(function (factory) {
    ...
    if (part) {
      ...
      "]" == part
        ...
        ? ((part = part.substr(0, part.length - 1)),
          !isint.test(part) && isArray(obj) && (obj = promote(parent, key)),
  ...
  function reduce(obj, accumulator) {
    for (var i = 0, l = obj.length >> 0, curr = arguments[2]; l > i; )
      i in obj && (curr = accumulator.call(void 0, curr, obj[i], i, obj)), ++i;
    return curr;
  }
      ...
      (url = url || window.location.toString()),
      {
        ...
        attr: function (attr) {
          return (
            ...
            "undefined" != typeof attr ? this.data.attr[attr] : this.data.attr
          );
        },
        ...
        segment: function (seg) {
          return "undefined" == typeof seg
            ? this.data.seg.path
            : ((seg = 0 > seg ? this.data.seg.path.length + seg : seg - 1),
              this.data.seg.path[seg]);
        },
        fsegment: function (seg) {
          return "undefined" == typeof seg
            ? this.data.seg.fragment
            : ((seg = 0 > seg ? this.data.seg.fragment.length + seg : seg - 1),
    ...
    (purl.jQuery = function ($) {
      null != $ &&
        (($.fn.url = function (strictMode) {
          var url = "";
          return (
            this.length && (url = $(this).attr(getAttrName(this[0])) || ""),
            purl(url, strictMode)
          );
        }),
        ($.url = purl));
