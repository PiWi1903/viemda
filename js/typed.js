!(function (t) {
  ...
  (s.prototype = {
    ...
    typewrite: function (t, s) {
      ...
      r.timeout = setTimeout(function () {
        ...
        if ("^" === o.charAt(0)) {
          var i = 1;
          /^\^\d+/.test(o) &&
            ((i += (o = /\d+/.exec(o)[0]).length), (e = parseInt(o))),
        ...
        if ("html" === r.contentType) {
          ...
          if ("<" === n || "&" === n) {
            var a;
            for (a = "<" === n ? ">" : ";"; t.substr(s).charAt(0) !== a; )
              t.substr(s).charAt(0), s++;
            s++, a;
          }
        }
        r.timeout = setTimeout(function () {
          if (s === t.length) {
            if (
              (r.options.onStringTyped(r.options.array_id),
              r.arrayPos === r.strings.length - 1 &&
                (r.options.callback(),
                r.curLoop++,
                !1 === r.loop || r.curLoop === r.loopCount))
            )
              return;
            r.timeout = setTimeout(function () {
              r.backspace(t, s);
          ...
          s > r.stopNum
            ...
            : s <= r.stopNum &&
              ...
              r.arrayPos === r.strings.length
                ? ((r.arrayPos = 0),
                  r.shuffle && (r.sequence = r.shuffleArray(r.sequence)),
                  r.init())
    ...
    shuffleArray: function (t) {
      ...
      if (r)
        for (; --r; )
          (s = t[(e = Math.floor(Math.random() * (r + 1)))]),
            (t[e] = t[r]),
            (t[r] = s);
      return t;
    },
    ...
    (t.fn.typed = function (e) {
      return this.each(function () {
        var r = t(this),
          o = r.data("typed");
        o || r.data("typed", (o = new s(this, "object" == typeof e && e))),
          "string" == typeof e && o[e]();
      });
    }),
    (t.fn.typed.defaults = {
